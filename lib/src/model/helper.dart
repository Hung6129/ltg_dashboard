...
void resetLocaleValue(KpiDashboardModel model, Item currentSample) {
...
void onTapExpandSample(
    BuildContext context, Item subItem, KpiDashboardModel model) {
  model.isCardView = false;
  final Function kpiDashboardWidget = model.kpiDashboardWidget[subItem.key]!;
  final SampleView sampleView =
      kpiDashboardWidget(GlobalKey<State>()) as SampleView;
  Navigator.push<dynamic>(
      context,
      MaterialPageRoute<dynamic>(
          builder: (BuildContext context) => _FullViewSampleLayout(
                kpiDashboardWidget: sampleView,
                sample: subItem,
              )));
  model.kpiDashboardWidget.clear();
...
List<TextSpan> getTextSpan(String description, KpiDashboardModel model) {
...
class _FullViewSampleLayout extends StatelessWidget {
  const _FullViewSampleLayout({this.sample, this.kpiDashboardWidget});
  final Item? sample;
  final Widget? kpiDashboardWidget;
  @override
                    ...
                    child: Scaffold(
                      ...
                      body: Container(
                          ...
                          padding: needPadding
                              ...
                              : EdgeInsets.zero,
                          child: Container(child: kpiDashboardWidget)),
                                  ...
                                  child: FloatingActionButton(
                                    ...
                                    onPressed: () {
                                      final GlobalKey sampleKey =
                                          kpiDashboardWidget!.key! as GlobalKey;
...
Widget getLeftSideDrawer(KpiDashboardModel model) {
  return LayoutBuilder(
...
Widget getFooter(BuildContext context, KpiDashboardModel model) {
  return Container(
    height: 60,
    decoration: BoxDecoration(
      border: Border(
...
Widget showWebThemeSettings(KpiDashboardModel model) {
...
void _applyThemeAndPaletteColor(
    KpiDashboardModel model, BuildContext context, int selectedValue) {
...
List<Widget> _addColorPalettes(KpiDashboardModel model,
...
void _changeColorPalette(KpiDashboardModel model, int index,
    [StateSetter? setState]) {
...
void showBottomSettingsPanel(KpiDashboardModel model, BuildContext context) {
