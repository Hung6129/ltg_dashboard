...
abstract class SampleView extends StatefulWidget {
  ...
  const SampleView({super.key, this.data});
}
...
abstract class SampleViewState<T extends SampleView> extends State<T> {
  ...
  /// Holds the KpiDashboardModel information
  late KpiDashboardModel model;
  ...
  @override
  void initState() {
    model = KpiDashboardModel.instance;
    data = widget.data;
          ...
          Container(
              ...
              child: DropdownButton<Locale>(
                  ...
                  items: _supportedLocales.map((Locale value) {
                    ...
                    if (this is DirectionalitySampleViewState) {
                      localeString =
                          (localeString == 'vi_VN') ? 'Tiếng Việt' : 'English';
                    } else {
                      localeString =
                    ...
                    if (model.locale != value) {
                      setState(() {
                        stateSetter(() {
                          ...
                          model.locale = value;
                          if (this is! DirectionalitySampleViewState) {
                            if (model.locale == const Locale('vi', 'VN')) {
